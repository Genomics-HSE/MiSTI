...
For simulated data use the scripts `utils/MS2JAF.py` (_msHOT-lite_ with __-l__ format) or `utils/SCRM2JAF.py` (for regular ms of scrm output format) to calculate joint SFS from simulated chromosomes.
